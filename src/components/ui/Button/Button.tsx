  ...
  ],
  {
    variants: {
      variant: {
        ...
        default:
          "bg-primary text-primary-foreground hover:bg-accent-hover active:bg-accent-active",
...
export interface ButtonProps
  ...
  asChild?: boolean;
  /**
   * Loading state: shows a spinning Loader2 icon before children, sets
 ...
 * - `loading` prop: Loader2 spinner + aria-busy, label preserved (no CLS)
